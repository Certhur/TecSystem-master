                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <option value="" selected disabled>Selecciona el Tipo de Equipo</option>
                                    </select>
                                </div>
                            </div>
...
$(document).ready(function() {
    ...
    cargarOpcionesSelect(direccionTipoEquipo, 'tipo_equipo', 'Selecciona el Tipo de Equipo'); 
    cargarOpcionesSelect(direccionCiudad, 'ciudad', 'Selecciona la ciudad');  // Cargar ciudad
});
            ...
            if (Array.isArray(response)) {
                ...
                response.forEach(item => {
                    if (selectId === 'cliente') {
                        ...
                        select.append(new Option(item.descrip_ciudad, item.cod_ciudad));
                    }    
                });

                 // Añadir la opción "Agregar nuevo cliente" o "Agregar nueva marca"
                 if (selectId === 'cliente') {
                ...
                select.trigger("chosen:updated");  // Si estás usando Chosen
...
// Función para abrir el modal si se selecciona "Agregar nueva marca"
